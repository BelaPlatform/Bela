...
;
;
; This first example is focusses on the different comment-types 
; and shows a simple program, which outputs a "440Hz beep" to 
; Bela's audio output and prints "Hello World" to the console.
;
