 ...
 * the Trill library and sonifies the different touches using oscillators.
 *
 ...
 *
 * Position and size for each touch and then mapped to frequency and amplitude of their 
