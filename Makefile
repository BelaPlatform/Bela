...
RUN_COMMAND?=bash $(RUN_FILE) $(COMMAND_LINE_OPTIONS)
else
...
LIB_EXTRA_OBJS = $(EXTRA_CORE_OBJS) build/core/GPIOcontrol.o libraries/Scope/build/Scope.o libraries/WSServer/build/WSServer.o libraries/UdpClient/build/UdpClient.o libraries/UdpServer/build/UdpServer.o libraries/Midi/build/Midi.o libraries/Midi/build/Midi_c.o libraries/Fft/build/Fft.o
.EXPORT_ALL_VARIABLES:
