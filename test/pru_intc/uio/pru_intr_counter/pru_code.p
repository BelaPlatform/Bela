...
START:
  ...
  //MCASP_REG_WRITE_EXT MCASP_XINTCTL, 0x10 // Enable last slot interrupt
  //MCASP_REG_WRITE_EXT MCASP_RINTCTL, 0x10 // Enable last slot interrupt
